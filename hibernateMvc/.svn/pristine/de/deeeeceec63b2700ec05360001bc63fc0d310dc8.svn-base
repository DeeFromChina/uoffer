...
<body bgColor="#FFF" onload="init()">
	...
	<table style="width:100%;">
		<tr height="25px"/>
		<tr>
			<td class="textC" style="width:24%;font-size:17px;color:#4F4F4F">简历展示设置</td>
			<td width="104px"/>
			<td/>
		</tr>
		<tr height="72px"/>
		<tr>
			...
			<td class="textR" style="padding-right:17px;">
				<font style="font-size:14px;" color="#4F4F4F">简历有效期</font>
			</td>
			<td>
				<select style="height:37px;width:300px;border:1px #CCCCCC solid;" id="youxiao">
				</select>
			</td>
		</tr>
		<tr height="16px"/>
		<tr>
			<td/>
			<td class="textR" style="padding-right:17px;">
				<font style="font-size:14px;" color="#4F4F4F">简历推荐时效</font>
			</td>
			<td>
				<select style="height:37px;width:300px;border:1px #CCCCCC solid;"id="tuijian" >
				</select>
			</td>
		</tr>
		<tr height="45px"/>
		<tr>
			...
			<td style="padding-left:30px;">
				...
				style="background-color: #00B38A !important; border-color: #00B38A !important; width: 180px; height: 41px;">
				保存</button>
			</td>
		</tr>
	</table>
