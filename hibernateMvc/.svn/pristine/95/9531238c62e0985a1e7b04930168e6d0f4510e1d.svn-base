...
<script language="javascript">
		...
		for(var i in items){
			...
			jobs = jobs + "<td class='textR' style='padding-top:10px;padding-bottom:10px;width:45;'>"
							+"<div class='icheckbox_square-green hover' onclick='jobId(this)' id='"+items[i].id+"'>"
								+"<input type='hidden'  name='CheckJob' value='"+items[i].value+"'/>"
	...
	function addCheckJob1(items){
		...
		for(var i in items){
			...
			jobs = jobs + "<td class='textR' style='padding-top:10px;padding-bottom:10px;width:45;'>"
							+"<div class='icheckbox_square-green hover' onclick='jobId(this)' id='"+items[i].id+"'>"
								+"<input type='hidden' name='CheckJob1' value='"+items[i].value+"'/>"
								+"<input tabindex='2' type='checkbox' style='opacity:0;'>"
							+"</div>"
						+"</td>"
						+"<td class='textL'><font size='2'>"+items[i].value+"</font></td>";
	...
	function addcity(items){
		...
		for(var i in items){
			...
			jobs = jobs + "<td class='textR' style='padding-top:10px;padding-bottom:10px;width:45;'>"
							+"<div class='icheckbox_square-green hover' onclick='jobId(this)' id='"+items[i].id+"'>"
								+"<input type='hidden' value='"+items[i].cityName+"'/>"
								+"<input tabindex='2' type='checkbox' style='opacity:0;'>"
							+"</div>"
						+"</td>"
						+"<td class='textL'><font size='2'>"+items[i].cityName+"</font></td>";
			if(j == 4){
				jobs = jobs + "</tr>";
				j = 1;
			}else{
