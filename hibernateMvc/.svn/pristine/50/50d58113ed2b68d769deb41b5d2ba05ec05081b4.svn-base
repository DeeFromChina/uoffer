...
<script language="javascript">
	...
	function changeColor4(){
		if(document.getElementById("type").value=="3"){
			...
			document.getElementById("button1").innerHTML="<font style='font-size:14px;' color='#FFF'>我是顾问</font>";
			document.getElementById("button2").style.background="#FFF";
			document.getElementById("button2").innerHTML="<font style='font-size:14px;' color='#00B38A'>我是管理员</font>";
		}
		if(document.getElementById("type").value=="4"){
			document.getElementById("button2").style.background="#00B38A";
			document.getElementById("button2").innerHTML="<font style='font-size:14px;' color='#FFF'>我是管理员</font>";
			document.getElementById("button1").style.background="#FFF";
			document.getElementById("button1").innerHTML="<font style='font-size:14px;' color='#00B38A'>我是顾问</font>";
		}
	}
	var code;
		...
		<div style="background: #FFFFFF; width: 800px;">
			...
			<table
				...
				<tr>
					...
					<td>
						<input type="text" name="name" class="form-control" style="width: 381px;height:41px;">
					</td>
				</tr>
				<tr height="1px"/>
				<tr>
					...
					<td>
						<input type="password" name="password" class="form-control" style="width: 381px;height:41px;">
					</td>
				</tr>
				<tr>
					<td class="textR">
					...
					<tr>
						<td colspan="2">
							<button type="button" class="btn btn-primary" onclick="validateCode()" data-toggle="button"
								style="height:40px;background-color: #00B38A !important; border-color: #00B38A !important; width: 381px;">
								确认提交</button>
						</td>
					</tr>
					<tr height="40px"/>
