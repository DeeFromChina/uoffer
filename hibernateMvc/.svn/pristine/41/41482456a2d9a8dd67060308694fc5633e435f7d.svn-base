	...
	<form id="returninterview">
		...
		<input type="hidden" id="type" name="type">
			<ul class="nav nav-tabs nav-justified" style="width:100%;">
			  <li style="bottom:-6px;float:left;width:20%;" class="active"><a href="#" onclick="selectinterview(7)" id="t7"><font color="#000" size="1">和ta沟通</font></a></li>
			  <li style="bottom:-6px;float:left;width:30%;" ><a href="#" onclick="selectinterview(8)" id="t8"><font color="#000" size="1">同意面试邀请</font></a></li>
			  <li style="bottom:-6px;float:left;width:30%;" ><a href="#" onclick="selectinterview(9)" id="t9"><font color="#000" size="1">拒绝面试邀请</font></a></li>
			</ul>
		</div>
