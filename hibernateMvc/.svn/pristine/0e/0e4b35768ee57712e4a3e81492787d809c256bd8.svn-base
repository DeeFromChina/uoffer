...
<script language="javascript">
	...
	function removebutton(obj){
		...
		removeHowMany += document.getElementById("removeHowMany").value + value + ";";
							...
							<td width="18%">
								<div class="input-group" style="margin-left:-10px !important;width: 160px !important">
									<div class="dropdown" style="">
										...
										<input type="text" name="firmsavedValue" id="firmsavedValue" class="form-control" style="width: 120px !important" placeholder="已保存的搜索">
							...
							<td width="18%">
								<div class="input-group" style="margin-left:-10px !important;width: 160px !important">
									<div class="dropdown" style="">
										...
										<input type="text" name="firmcityValue" id="firmcityValue" class="form-control" style="width: 120px !important" placeholder="城市">
									    <button type="button" style="height:34px !important;background-color:#E6E6E6;" class="btn dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown">
									        <span class="caret"></span>
									    </button>
							...
							<td width="18%">
								<div class="input-group" style="margin-left:-10px !important;width: 160px !important">
									<div class="dropdown" style="">
										...
										<input type="text" name="firmjobValue" id="firmjobValue" class="form-control" style="width: 120px !important" placeholder="职位">
									    <button type="button" style="height:34px !important;background-color:#E6E6E6;" class="btn dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown">
									        <span class="caret"></span>
									    </button>
							...
							<td width="18%">
								<div class="input-group" style="margin-left:-10px !important;width: 160px !important">
									<div class="dropdown" style="">
										...
										<input type="text" name="firmworkedValue" id="firmworkedValue" class="form-control" style="width: 120px !important" placeholder="工作经验">
									    <button type="button" style="height:34px !important;background-color:#E6E6E6;" class="btn dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown">
									        <span class="caret"></span>
									    </button>
