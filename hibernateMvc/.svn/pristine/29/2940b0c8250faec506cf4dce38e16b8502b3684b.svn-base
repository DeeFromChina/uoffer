	...
	<div style="width:100%;padding:0px 200px;margin-top:48px;">
		<table width="100%" id="searchBanner">
			...
			<tr>
				<td width="220px">
					<div class="input-group" style="width: 100%;">
						<div class="dropdown" style="">
							...
							<input type="text" name="firmstatusValue" id="firmstatusValue" class="form-control" placeholder="流程状态" style="width: 164px !important">
				...
				<td width="220px">
		            <input type="text" class="form-control" style="width:90%" placeholder="姓名">
				</td>
				<td/>
				<!-- <td class="textR">
