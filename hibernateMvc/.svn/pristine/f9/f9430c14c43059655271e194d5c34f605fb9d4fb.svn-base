...
<script language="javascript">
	...
	function addmsgDiv(items){
		...
		var j = 0;
		for(var i in items){
			div1 = div1 + "<div style='width:100%' onmouseover='appacerdiv(this)' id='d"+j+"' style='min-height:75px;'>"
							...
							+"</table>"
						+"</div>"
						+"<div style='width:100%;z-index:9999;display:none;' onmouseout='displaydiv(this)' id='e"+j+"'>"
