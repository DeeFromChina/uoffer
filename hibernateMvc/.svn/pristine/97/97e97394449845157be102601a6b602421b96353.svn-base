...
<script language="javascript">
	...
	function validateCode() {
		var ispass = code.verify(document.getElementById("inputCode").value);
		if (ispass) {
		...
		<div style="background: #FFFFFF; width: 600px;">
			<table width="100%">
				...
				<tr>
					<td/>
					<td class="textC">
						<font size="1" color="#00B38A" class="textC">邮箱地址</font>
					</td>
					<td></td>
					<td class="textC">
						<font size="1" color="#00B38A" class="textC">验证邮箱</font>
					</td>
					<td></td>
					<td class="textC">
						<font size="1" color="#00B38A" class="textC">重置密码</font>
					</td>
					<td/>
				</tr>
				<tr height="36px"/>
				...
				<tr>
					...
					<td colspan="5">
						<center>
							<button id="button2" type="button" class="btn btn-default" style="width:280px;background:#00B38A;color:#FFF;"
								>确认提交</button>
						</center>
					</td>
					<td/>
