...
<script language="javascript">
	...
	$(function () { $('#collapseEleven').collapse('hide')});
	function test(obj){
				...
				<td style="padding-left:30px;" colspan="2">
					<table width="100%">
						<tr>
							...
							<td>
								<font color="#4F4F4F" style="font-size:16px;">1、uoffer主要服务哪些人才？</font>
							</td>
							<td style="padding-right:200px;" class="textR">
								<a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
									<img src="../img/download.png" width="17px" height="17px" style="-webkit-transform:rotate(270deg)" onclick="test(this)"/>
				                </a>
							</td>
						</tr>
						<tr height="26px"/>
					...
					<table width="100%">
						<tr>
							...
							<td>
								<font color="#4F4F4F" style="font-size:16px;">2、使用uoffer与使用其他招聘网站有什么区别？</font>
							</td>
							<td style="padding-right:200px;" class="textR">
					...
					<table width="100%">
						<tr>
							...
							<td>
								<font color="#4F4F4F" style="font-size:16px;">3、Uoffer与朋友推荐、猎头相比，有什么优势？</font>
							</td>
							<td style="padding-right:200px;" class="textR">
					...
					<table width="100%">
						<tr>
							...
							<td>
								<font color="#4F4F4F" style="font-size:16px;">4、uoffer使用流程中的时间安排是怎样的？</font>
							</td>
							<td style="padding-right:200px;" class="textR">
					...
					<table width="100%">
						<tr>
							...
							<td>
								<font color="#4F4F4F" style="font-size:16px;">5、哪些公司能看到我的个人资料？</font>
							</td>
							<td style="padding-right:200px;" class="textR">
					...
					<table width="100%">
						<tr>
							...
							<td>
								<font color="#4F4F4F" style="font-size:16px;">6、Uoffer如何筛选合作企业？</font>
							</td>
							<td style="padding-right:200px;" class="textR">
					...
					<table width="100%">
						<tr>
							...
							<td>
								<font color="#4F4F4F" style="font-size:16px;">7、uoffer怎样保护我的隐私？</font>
							</td>
							<td style="padding-right:200px;" class="textR">
					...
					<table width="100%">
						<tr>
							...
							<td>
								<font color="#4F4F4F" style="font-size:16px;">8、uoffer收费吗？</font>
							</td>
							<td style="padding-right:200px;" class="textR">
					...
					<table width="100%">
						<tr>
							...
							<td>
								<font color="#4F4F4F" style="font-size:16px;">9、我可以在100offer上投递简历吗？</font>
							</td>
							<td style="padding-right:200px;" class="textR">
					...
					<table width="100%">
						<tr>
							...
							<td>
								<font color="#4F4F4F" style="font-size:16px;">10、我只想看一下市场行情，并不想换工作，可以使用uoffer吗？</font>
							</td>
							<td style="padding-right:200px;" class="textR">
					...
					<table width="100%">
						<tr>
							...
							<td>
								<font color="#4F4F4F" style="font-size:16px;">11、当前的简历展示期结束后，我可以继续参加下一期吗？</font>
							</td>
							<td style="padding-right:200px;" class="textR">
