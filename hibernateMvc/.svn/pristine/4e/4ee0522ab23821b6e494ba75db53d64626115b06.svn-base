...
//      message.setRecipient(RecipientType.CC, bcc);
      ...
      // 设置邮件的内容体
      message.setContent("尊敬的用户 [0]，您好：<p>您使用了邮箱[1]进行账号激活。请在24小时内点击以下链接，完成您的账号激活：<br/><a href='http://[2]' >[2]</a><br/>如果以上链接不能点击，你可以复制网址URL，然后粘贴到浏览器地址栏打开，完成确认。<br/>如果你没有注册过，可能是有人尝试使用你的邮件来进行绑定，请忽略本邮件。<br/>（这是一封自动发送的邮件，请不要直接回复）<br/></p>", "text/html;charset=UTF-8");
