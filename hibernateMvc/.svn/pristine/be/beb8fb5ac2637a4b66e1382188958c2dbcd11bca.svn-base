...
public interface OfferFirmSelectService {

	public Map<String, List<Map<String, String>>> findList(String firmId) throws Exception;
	
	public Map<String, List<Map<String, String>>> findList1(String firmId) throws Exception;
