				...
				<td width="220px">
					<div class="input-group" style="width: 100%;">
						<div class="dropdown">
						    ...
						    <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1" style="margin-left:-20px;width: 90% !important" id="city1">
				...
				<td width="220px">
					<div class="input-group" style="width: 100%;">
						<div class="dropdown">
							...
							<input type="text" name="firmstatusValue" id="firmstatusValue" class="form-control" placeholder="状态" style="margin-left:-20px;width: 164px !important">
						    <button type="button" style="height:34px !important;background-color:#3CBAFF;color:#FFF;" class="btn dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown">
						        <span class="caret"></span>
						    </button>
