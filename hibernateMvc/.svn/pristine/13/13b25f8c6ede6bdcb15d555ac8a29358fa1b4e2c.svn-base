		...
		document.getElementById(jobId).innerHTML = "<td/>"
		 +"<td colspan='3' class='textL'>"
		 	+"<div class='input-group' style='width:590px;'>"
				+"<div class='dropdown'>"
			 		+"<input type='text' name='"+jobName+"' id='"+jobName+"' class='form-control' style='width:545px;' readOnly>"
...
// 				 			+"<a role='menuitem' tabindex='-1' onclick=\"workTime('五年以上','"+jobName+"')\"><font color='#000'>五年以上</font></a>"
	...
	function addCheckJob(items){
		...
		for(var i in items.nowJobList1){
			...
			jobs1 = jobs1 + "<td style='padding-top:10px;padding-bottom:10px;width:28px;'>"
		...
		for(var i in items.nowJobList2){
			...
			jobs2 = jobs2 + "<td style='padding-top:10px;padding-bottom:10px;width:28px;'>"
		...
		for(var i in items.nowJobList3){
			...
			jobs3 = jobs3 + "<td style='padding-top:10px;padding-bottom:10px;width:28px;'>"
	...
	<form id="finduserForm">
		<table width="100%">
			...
			<tr>
				<td/>
				<td colspan="3">
					<div class="input-group" style="width:593px">
						<div class="dropdown" style="width:100%;">
							<input type="text" readOnly="readOnly" class="form-control" style="width:545px;" name="offerJobValue" id="offerJobValue">
			...
			<tr>
				...
				<td colspan="3">
					<div class="input-group" style="width:593px">
						<div class="dropdown" style="width:100%;">
							<input type="text" readOnly="readOnly" class="form-control" style="width:545px;" id="offerUserWorktime" name="offerUserWorktime">
						    <button type="button" style="width:41px;height:41px !important;border:1px #CCCCCC solid;background-color:#F5F8F9;" class="btn dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown">
						        <span class="caret"></span>
						    </button>
			...
			<tr>
				<td/>
				<td>
					<font color="#4F4F4F" style="font-size:16px;" >您擅长哪些工作技能？</font><font color="#00B38A">（请用逗号分隔你的技能特长）</font>
				</td>
			</tr>
			<tr height="13px"/>
			<tr>
				<td/>
				<td colspan="3">
					<input type="text" name="offerUserDescription" id="offerUserDescription" class="form-control" style="width: 589px;">
				</td>
			</tr>
			<tr height="50px"/>
			<tr>
