...
// 		document.getElementById("endless").value = data;
		...
		for(var i in strs){
			...
			if(i==0){
				...
				tr1.innerHTML = "<td style='padding-top:20px;width: 42% !important;min-width:200px;'>"
									+"<input type='text' value='"+strs[i]+"'class='form-control' placeholder='assss@baidu.com' style='width: 100% !important;min-width:200px;height:41px;border-right:none;border-radius: 0;'>"
								+"</td>"
								+"<td width='41px' style='padding-top:20px;'>"
									+"<span class='input-group-addon' style='padding:0px 5px;width:41px;height:40px;background:#FFF;border:1px #CCCCCC solid;border-left:none;'><img src='../img/jian.png' width='30px' height='30px' style='cursor:pointer;' onclick='cleartd()'/></span>"
								+"</td>"
								+"<td style='padding-left:30px;padding-top:20px;'>"
									+"<img src='../img/jia.png' width='30px' height='30px' style='cursor:pointer;' onclick='addtr()'/>"
								+"</td>"
								;
				...
				tr1.innerHTML = "<td style='padding-top:20px;width: 42% !important;min-width:200px;'>"
								...
								+"</td>"
								+"<td width='41px' style='padding-top:20px;'>"
									+"<span class='input-group-addon' style='padding:0px 5px;width:41px;height:40px;background:#FFF;border:1px #CCCCCC solid;border-left:none;'><img src='../img/jian.png' width='30px' height='30px' style='cursor:pointer;' onclick='deltr(this)'/></span>"
								+"</td>"
								+"<td style='padding-left:30px;padding-top:20px;'>"
									+"<img src='../img/jia.png' width='30px' height='30px' style='cursor:pointer;' onclick='addtr()'/>"
								+"</td>"
	...
	function addtr(){
		...
		tr1.innerHTML = "<td style='padding-top:20px;width: 42% !important;min-width:200px;'>"
						...
						+"</td>"
						+"<td width='41px' style='padding-top:20px;'>"
							+"<span class='input-group-addon' style='padding:0px 5px;width:41px;height:40px;background:#FFF;border:1px #CCCCCC solid;border-left:none;'><img src='../img/jian.png' style='cursor:pointer;' width='30px' height='30px' onclick='deltr(this)'/></span>"
						+"</td>"
						+"<td style='padding-left:30px;padding-top:20px;'>"
							+"<img src='../img/jia.png' width='30px' height='30px' style='cursor:pointer;' onclick='addtr()'/>"
						+"</td>"
