		...
		for(var i in items){
			...
			if (cStatus == '2') {
				cStatus = "<tr><td style='width:40px !important;' class='textL'/><td class='textL' style='padding:20px;'>"
					+ "<font style='font-size:14px;color:#00B389;'>同意面试邀请</font>"
					+ "</td></tr>"
			}
			else if (cStatus == '3') {
				cStatus = "<tr><td style='width:40px !important;' class='textL'/><td class='textL' style='padding:20px;'>"
					+ "<font style='font-size:14px;color:#00B389;'>面试通知</font>"
					+ "</td></tr>"
			}
			else if (cStatus == '4') {
				cStatus = "<tr><td style='width:40px !important;' class='textL'/><td class='textL' style='padding:20px;'>"
					+ "<font style='font-size:14px;color:#00B389;'>面试通过</font>"
					+ "</td></tr>"
			}
			else if (cStatus == '5') {
				cStatus = "<tr><td style='width:40px !important;' class='textL'/><td class='textL' style='padding:20px;'>"
					+ "<font style='font-size:14px;color:#00B389;'>面试不通过</font>"
					+ "</td></tr>"
			}
			else if (cStatus == '6') {
				cStatus = "<tr><td style='width:40px !important;' class='textL'/><td class='textL' style='padding:20px;'>"
					+ "<font style='font-size:14px;' color='red'>拒绝面试</font>"
					+ "</td></tr>"
			}
			else if (cStatus == '7') {
				cStatus = "<tr><td style='width:40px !important;' class='textL'/><td class='textL' style='padding:20px;'>"
...
<body onload="init()">
	...
	<div class="getColor" style="width:100%;" id="header">
		<table style=" width: 100%;padding-top:5px;padding-left:50px;border-collapse:separate !important;">
			...
			<tr>
				<td class="textL"><font style='font-size:14px;color:#9A9A9A;'>职位：</font><font style='font-size:14px;color:#4F4F4F;' id="firmJob"></font></td>
			</tr>
			<tr>
				<td class="textL"><font style='font-size:14px;color:#9A9A9A;'>薪酬：</font><font style='font-size:14px;color:#4F4F4F;' id="firmMoney"></font></td>
			</tr>
			<tr>
				<td class="textL"><font style='font-size:14px;color:#9A9A9A;'>期权/股权：</font><font style='font-size:14px;color:#4F4F4F;' id="firmQiQuan"></font></td>
			</tr>
			<tr>
				<td class="textL"><font style='font-size:14px;color:#9A9A9A;'>公司简介：</font><font style='font-size:14px;color:#4F4F4F;' id="firmResume"></font></td>
			</tr>
			<tr height="20px"/>
		</table>
	</div>
