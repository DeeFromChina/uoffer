...
<script language="javascript">
		...
		for(var i in items){
			div1 = div1 + "<div style='width:100%' onmouseover='appacerdiv(this)' id='d"+i+"' style='min-height:75px;'>"
							+"<table width='100%' id='editMsg'>"
								+"<tr height='30px'/>"
								+"<tr>"
									+"<td width='34px' rowspan='5' valign='top'><img src='../img/firm.png' width='18px' height='18px'/></td>"
									+"<td width='69%'>"
										+"<font color='#4F4F4F' style='font-size:14px;' >"+items[i].firmName+"</font>"
									+"</td>"
									+"<td class='textC' valign='top' style='padding-top:5px;'>"
										+"<font color='#00B389' style='font-size:14px;' >"+items[i].jobstart+"~"+items[i].jobend+"</font>"
									+"</td>"
								+"</tr>"
								+"<tr height='13px'/>"
								+"<tr>"
							...
							+"<table width='100%' style='height:100%;'>"
								+"<tr>"
									...
									+"<td width='100px'>"
										...
										+"删除"
										+"</button>" */
										+"<img src='../img/lajitong.png' id='del_"+items[i].thisId+"' onclick='delWork(this)'/>"
									+"</td>"
									+"<td width='100px'>"
										...
										+"编辑"
										+"</button>" */
										+"<img src='../img/bianji.png' id='edit_"+items[i].thisId+"' onclick='editWork(this)'/>"
									+"</td>"
									+"<td width='15%'/>"
								+"</tr>"
							+"</table>"
	...
	function editWork(obj) {
		...
		if (toNow == 'true') {
			...
			document.getElementById("jobend").disabled = true;
		}
		else {
	...
	function changeToNow() {
		if (document.getElementById("toNowWork").checked==true) document.getElementById("jobend").disabled = true;
		else document.getElementById("jobend").disabled = false;
	}
</script>
		...
		<form id="resumeAddWorkexperienceForm1">
			...
			<table width="100%" id="xiaoshi">
					...
					<td colspan="3">
						<table width="100%">
							<tr>
								...
								<td width="201px">
									<div class='input-append date form_datetime2' style="width:100%;">
								...
								<td class="textL" valign="bottom">
									...
									<input type="checkbox" id="toNowWork" name="toNowWork" onclick="changeToNow()"/><font color="#4F4F4F" style="font-size:16px;" >至今</font>
								</td>
								<td/>
							</tr>
						</table>
				...
				<tr>
					<td/>
					<td colspan="3">
						<textarea rows="8" style="max-width:789px;height:201px;min-width:500px;width:90%;" id="workcontent" name="workcontent"></textarea>
					</td>
				</tr>
				<tr height="50px"/>
				<tr>
