...
// 		var data = ajaxSumbit(url, formId);
	...
	function selectItem(obj){
		/* $(".textC").each(function () {
			if(this.style.background == '#00B38A'){
				this.style.color == '#00B38A';
		...
		<tr>
			...
			<td valign="top" width="263px">
				<table style="background:#FFF;width:100%;">
					...
					<tr><td class="textC" style="padding-top:33px;" onclick="selectItem(this)" id="1"><img id="information" style="width:40px;padding:0px 10px;display:none;"/><font style="font-size:14px" color="#00B38A">个人信息</font></td></tr>
					<tr><td class="textC" style="padding-top:24px;" onclick="selectItem(this)" id="2"><img id="skill" style="width:40px;padding:0px 10px;display:none;"/><font style="font-size:14px" color="#00B38A">个人技能</font></td></tr>
					<tr><td class="textC" style="padding-top:24px;" onclick="selectItem(this)" id="3"><img id="work" style="width:40px;padding:0px 10px;display:none;"/><font style="font-size:14px" color="#00B38A">工作经历</font></td></tr>
					<tr><td class="textC" style="padding-top:24px;" onclick="selectItem(this)" id="4"><img id="education" style="width:40px;padding:0px 10px;display:none;"/><font style="font-size:14px" color="#00B38A">教育经历</font></td></tr>
					<tr><td class="textC" style="padding-top:24px;" onclick="selectItem(this)" id="5"><img id="project" style="width:40px;padding:0px 10px;display:none;"/><font style="font-size:14px" color="#00B38A">项目经历</font></td></tr>
					<tr><td class="textC" style="padding-top:24px;" onclick="selectItem(this)" id="6"><img id="description" style="width:40px;padding:0px 10px;display:none;"/><font style="font-size:14px" color="#00B38A">个人描述</font></td></tr>
					<tr><td class="textC" style="padding-top:24px;" onclick="selectItem(this)" id="7"><img id="works" style="width:40px;padding:0px 10px;display:none;"/><font style="font-size:14px" color="#00B38A">个人作品</font></td></tr>
					<tr><td class="textC" style="padding-top:24px;" onclick="selectItem(this)" id="8"><img id="protect" style="width:40px;padding:0px 10px;display:none;"/><font style="font-size:14px" color="#00B38A">隐私保护</font></td></tr>
					<tr>
			...
			<td width="56%" id="main1" valign="top" style="min-width:760px;">
				<iframe src="edit_resume7.jsp" name="mainFrame" scrolling="auto" id="mainFrame" title="mainFrame" style="width:100%;height:100%;border:none;"></iframe>
			</td>
			<td/>
		</tr>
		<tr height="40px"/>
