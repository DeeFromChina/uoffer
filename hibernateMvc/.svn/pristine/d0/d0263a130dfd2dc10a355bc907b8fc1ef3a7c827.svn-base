...
<script language="javascript">
	...
	function addallorpair(allnum,pairnum){
		parent.document.getElementById('divall').innerHTML="<font style='font-size:14px;' color='#4F4F4F'>全部（"+allnum+")</font>";
		parent.document.getElementById('divpair').innerHTML="<font style='font-size:14px;' color='#4F4F4F'>已收藏（"+pairnum+")</font>";
	}
			...
			div1 = div1+"<div class='getColor' tabindex='0' style='width:100%;cursor:pointer;' onmouseover='color3(this)' onmouseout='color4(this)' >"//onclick='goView(\""+item.id+"\")'
				+"<table style=' width: 100%;padding-top:5px;padding-left:10px;'>" 
							...
							+"<tr>"
								...
								+"</td>"
								+"<td width='69%'>"
									+"<font  style='font-size:20px;color:#4F4F4F;'>" + item.username + "</font>"
								+"</td>"
								+"<td/>"
							+"</tr>"
							+"<tr>"
								+"<td class='textL' style='padding-right:25%;'><font style='font-size:14px;' color='#4F4F4F'>" + item.nowyearwages + "</font></td>"
								+"<td class='textR' rowspan='2' width='20%'>"
									+"<table width='100%'>"
										+"<tr>"
											+"<td width='50%' class='textR' style='padding-left:5px;'>"
												+"<div class='btn-group btn-group-lg'>"
													+"<button type='button' class='btn btn-default' name='nofeel"+item.id+"' onclick='nofeel(\""+item.id+"\")' onmouseover='color1(this)' onmouseout='color2(this)' style='width: 120px;color:#9A9A9A;border:1px #CCCCCC solid;'>"
														+"<center><img src='../img/delete.png' width='16px' height='16px' id='nofeel"+item.id+"' />"
											...
											+"<td width='50%' class='textL' style='padding-left:5px;'>"
												+"<div class='btn-group btn-group-lg'>"
													+"<button id='regit' type='button' class='btn btn-default' name='hadfeel"+item.id+"' onclick='hadfeel(\""+item.id+"\")' onmouseover='color1(this)' onmouseout='color2(this)' style='width:120px;color:#9A9A9A;border:1px #CCCCCC solid;'>"
														+"<center><img src='../img/collection.png' width='16px' height='16px' id='hadfeel"+item.id+"'/>"
...
// 							+"</tr>"
							+"<tr>"//工作说明：
							+"<td class='textL' style='padding-right:25%;'><font style='font-size:14px;' color='#CCCCCC'></font><font style='font-size:14px;' color='#4F4F4F'>" + item.jobDescript.substring(0, 115) + "</font></td>"
							+"<td/>"
						+"</tr>"
						+"<tr>"//公司：
							+"<td class='textL' style='padding-right:25%;'><font style='font-size:14px;' color='#CCCCCC'></font><font style='font-size:14px;' color='#4F4F4F'>" + item.oldFirmName + "</font></td>"
							+"<td/>"
						+"</tr>"
							+"<tr>"//学校：
								+"<td class='textL' style='padding-right:25%;'><font style='font-size:14px;' color='#4F4F4F'></font><font style='font-size:14px;' color='#4F4F4F'>" + (item.xueli == '' ? '' : item.xueli + "，") + item.school + "</font></td>"
								+"<td/>"
							+"</tr>"
							+"<tr height='39px'/>"
						+"</table>"
		...
		for(var i in data.userresume){
			...
			div1 = div1+"<div class='getColor' tabindex='0' style='width:100%;cursor:pointer;' >"//onclick='goView(\""+item.id+"\")'
				+"<table style=' width: 100%;padding-top:5px;padding-left:10px;'>" 
							...
							+"</tr>"
							+"<tr>"
								+"<td class='textL'><font style='font-size:14px;' color='#CCCCCC'>职位：</font><font style='font-size:14px;' color='#4F4F4F'>" + item.resume + "</font></td>"
								+"<td/>"
							+"</tr>"
							+"<tr>"
							+"<td class='textL'><font style='font-size:14px;' color='#CCCCCC'>工作说明：</font><font style='font-size:14px;' color='#4F4F4F'>" + item.jobDescript + "</font></td>"
							+"<td/>"
						+"</tr>"
							+"<tr>"
								+"<td class='textL'><font style='font-size:14px;' color='#CCCCCC'>学校：</font><font style='font-size:14px;' color='#4F4F4F'>" + (item.xueli == '' ? '' : item.xueli + "，") + item.school + "</font></td>"
								+"<td/>"
							+"</tr>"
						+"</table>"
					+"</div>"
