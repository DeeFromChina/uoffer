		...
		<div style="background: #FFFFFF; width: 800px;">
			<table width="100%">
				...
				<tr>
					<td/>
					<td class="textC">
						<font size="1" color="#00B38A" style="width:60px;" class="textC">邮箱地址</font>
					</td>
					<td></td>
					<td class="textC">
						<font size="1" color="#CCCCCC" style="width:60px;" class="textC">验证邮箱</font>
					</td>
					<td></td>
					<td class="textC">
						<font size="1" color="#CCCCCC" style="width:60px;" class="textC">重置密码</font>
					</td>
					<td/>
				</tr>
				<tr height="58px"/>
				<tr>
					...
					<td class="text" colspan="5">
						<font size="1">密码重置邮件已发送你的邮箱:</font>
					</td>
					<td/>
				</tr>
				<tr height="20px"/>
				<tr>
					<td/>
					<td class="text" colspan="5">
						<font size="1" id="email">xxx@xxx.xom</font>
					</td>
					<td/>
				</tr>
				<tr height="20px"/>
				<tr>
					<td/>
					<td class="text" colspan="5">
						<font size="1" color="#CCCCCC">请尽快登陆你的邮箱接收邮件，链接激活后可重置密码。</font>
					</td>
					<td/>
				</tr>
				<tr height="167px"/>
