			...
			<table style="border-collapse: separate; border-spacing: 10px; width: 100%;" id="userTable">
				<tr>
					...
					<td style="padding-bottom:3px;">
						<input type="text" name="email" class="form-control" style="width: 381px;" id="email" placeholder="请输入邮箱">
					</td>
				</tr>
				<tr height="53px">
					<td class="textR" width="25%">
					...
					<td style="padding-top:6px;">
						<div class="input-group" style="display:inline;margin-left:-10px !important;width: 410px;">
							<div class="dropdown" style="">
								<input type="text" name="jobFvalue" id="jobFvalue" class="form-control" readOnly="readOnly" style="width: 340px;" placeholder="选择职业方向">
				...
				<tr height="62px">
					...
					<div class="input-group" style="display:inline;margin-left:-10px !important;width: 410px;">
						<div class="dropdown" style="">
							<input type="text" name="cityvalue" id="cityvalue" class="form-control" readOnly="readOnly" style="width: 340px;" placeholder="选择所在城市">
						    <button type="button" style="width:41px;height:41px !important;border:1px #CCCCCC solid;background-color:#F5F8F9;" class="btn dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown">
						        <span class="caret"></span>
						    </button>
				...
				<tr>
					...
					<div class="input-group" style="margin-left:-10px !important;width:410px;">
						<div class="dropdown" style="">
							...
							<input type="text" name="nowjobvalue" id="nowjobvalue" readOnly="readOnly" class="form-control" style="width: 340px;" placeholder="目前职位：">
						    <button type="button" style="width:41px;height:41px !important;border:1px #CCCCCC solid;background-color:#F5F8F9;" class="btn dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown">
						        <span class="caret"></span>
						    </button>
						    <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1" style="width: 381px;" id="nowjob"><!-- max-height:100px;overflow-y:auto; -->
