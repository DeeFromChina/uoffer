		...
		for(var i in items){
			...
			div1 = div1 + "<div class='getColor' style='width:100%;'>"
							+ "<table style='width: 100%;padding-top:25px;padding-left:50px;border-collapse:separate !important;'>"
								...
								+ cStatus
								+ "<tr>"
								+ "<td style='width:40px !important;' class='textL'/><td class='textL' colspan='2' style='padding:10px 100px 20px 20px;'><font style='font-size:14px;color:#4F4F4F;'>"+items[i].content+"</font></td>"
								+ "</tr>"
							+ "</table>"
						+ "</div>";
		}
...
<body onload="init()">
	<div class="getColor" style="width:100%;" id="header">
		<table style=" width: 100%;padding-top:5px;padding-left:50px;border-collapse:separate !important;">
			<tr>
				<td>
					<font style='font-size:20px;color:#4F4F4F;' id="firmName"></font>
				</td>
			...
			<tr>
				<td class="textL"><font style='font-size:14px;color:#4F4F4F;' id="firmAddress"></font></td>
			</tr>
			<tr>
				<td class="textL"><font style='font-size:14px;' color="#9A9A9A">职位：</font><font style='font-size:14px;' id="firmJob" color="#4F4F4F"></font></td>
			</tr>
			<tr>
				<td class="textL"><font style='font-size:14px;' color="#9A9A9A">薪酬：</font><font style='font-size:14px;' id="firmMoney" color="#4F4F4F"></font></td>
			</tr>
			<tr>
				<td class="textL"><font style='font-size:14px;' color="#9A9A9A">期权/股权：</font><font style='font-size:14px;' id="firmQiQuan" color="#4F4F4F"></font></td>
			</tr>
			<tr>
				<td class="textL"><font style='font-size:14px;' color="#9A9A9A">公司简介：</font><font style='font-size:14px;' id="firmResume" color="#4F4F4F"></font></td>
			</tr>
			<tr height="20px"/>
		</table>
	</div>
	...
	<form id="returninterview">
		...
		<input type="hidden" id="type" name="type">
			<ul class="nav nav-tabs nav-justified" style="width:100%;"><!-- href="#"  -->
			  <li style="bottom:-6px;float:left;width:20%;" class="active"><a onclick="selectinterview(7)" id="t7"><font style='font-size:14px;color:#4F4F4F;'>和ta沟通</font></a></li>
			  <li style="bottom:-6px;float:left;width:30%;" ><a onclick="selectinterview(8)" id="t8"><font style='font-size:14px;color:#4F4F4F;'>同意面试邀请</font></a></li>
			  <li style="bottom:-6px;float:left;width:30%;" ><a onclick="selectinterview(9)" id="t9"><font style='font-size:14px;color:#4F4F4F;'>拒绝面试邀请</font></a></li>
			</ul>
		</div>
		<div class="getColor" style="width:100%;" >
			<table style=" width: 100%;padding-top:25px;padding-left:50px;border-collapse:separate !important;" id="interviewdiv">
				<tr>
					<td style="width:90px !important;padding:10px 0px;" class="textL">
						<font style='font-size:14px;color:#4F4F4F;'>如果你对此邀请不满意，你可以拒绝企业邀请</font>
					</td>
				</tr>
				<tr>
					<td class="textL">
