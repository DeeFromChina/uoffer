		...
		<tr>
			...
			<td rowspan="10" valign="top" style="min-width:200px;width:13%;" valign="top">
				...
				<table width="100%" style="background:#FFF">
					...
					<tr><td class="textL" style="border-bottom:1px #E3E6E6 solid;cursor:pointer;padding-top:15px;padding-bottom:15px;padding-left:25%;" onmouseover="changeColor3(this)" onmouseout="changeColor4(this)" id="type2" onclick="selectInterviewType(2)"><font>待沟通</font></td></tr>
					<tr><td class="textL" style="border-bottom:1px #E3E6E6 solid;cursor:pointer;padding-top:15px;padding-bottom:15px;padding-left:25%;" onmouseover="changeColor3(this)" onmouseout="changeColor4(this)" id="type3" onclick="selectInterviewType(3)"><font>待安排面试</font></td></tr>
					<tr><td class="textL" style="border-bottom:1px #E3E6E6 solid;cursor:pointer;padding-top:15px;padding-bottom:15px;padding-left:25%;" onmouseover="changeColor3(this)" onmouseout="changeColor4(this)" id="type4" onclick="selectInterviewType(4)"><font>已安排面试</font></td></tr>
					<tr><td class="textL" style="border-bottom:1px #E3E6E6 solid;cursor:pointer;padding-top:15px;padding-bottom:15px;padding-left:25%;" onmouseover="changeColor3(this)" onmouseout="changeColor4(this)" id="type5" onclick="selectInterviewType(5)"><font>面试结果</font></td></tr>
					<tr><td class="textL" style="border-bottom:1px #E3E6E6 solid;cursor:pointer;padding-top:15px;padding-bottom:15px;padding-left:25%;" onmouseover="changeColor3(this)" onmouseout="changeColor4(this)" id="type6" onclick="selectInterviewType(6)"><font>已拒绝面试邀请</font></td></tr>
				</table>
			</td>
