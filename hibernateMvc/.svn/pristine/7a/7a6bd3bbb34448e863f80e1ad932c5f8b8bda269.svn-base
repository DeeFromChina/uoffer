			...
			<table width="100%">
				...
				<tr height="60px">
					...
					<td width="69%">
						<div class="input-group">
							<div class="dropdown">
								<input type="text" name="firmAllName" id="firmAllName" class="form-control" style="width: 401px;">
							</div>
						</div>
					</td>
				</tr>
				<tr height="60px">
					...
					<td>
						<div class="input-group">
							<div class="dropdown">
								<input type="text" name="firmWebLink" id="firmWebLink" class="form-control" style="width: 401px;">
							</div>
						</div>
					</td>
				</tr>
				<tr height="60px">
					...
					<td>
						...
						<div class="input-group" style="width: 410px;">
							<div class="dropdown">
								<input type="text" name="firmStageValue" id="firmStageValue" class="form-control" style="width: 360px;">
				...
				<tr height="60px">
					...
					<td>
						...
						<div class="input-group" style="width: 410px;">
							<div class="dropdown">
								<input type="text" name="firmCityValue" id="firmCityValue" class="form-control" style="width: 360px;">
							    <button type="button" style="width:41px;height:41px !important;border:1px #CCCCCC solid;background-color:#F5F8F9;" class="btn dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown">
							        <span class="caret"></span>
							    </button>
				...
				<tr height="60px">
					...
					<td>
						...
						<div class="input-group" style="width: 410px;">
							<div class="dropdown">
								<input type="text" name="firmxuqiuValue" id="firmxuqiuValue" class="form-control" style="width: 360px;">
							    <button type="button" style="width:41px;height:41px !important;border:1px #CCCCCC solid;background-color:#F5F8F9;" class="btn dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown">
							        <span class="caret"></span>
							    </button>
