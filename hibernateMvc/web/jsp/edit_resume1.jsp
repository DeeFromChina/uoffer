...
// 			editCheckJob(data.jobId1,data.jobId2, data.jobvalue1, data.jobvalue2);
	...
	function workplaceId(obj){
		document.getElementById("offerUserCity").value = obj.id;
		document.getElementById("offerUserCityValue").value = obj.innerText;
	}
	...
	function checkValue() {
		...
		if(!checkInput('offerUserCity',"你目前所在的城市","30",false)) return false;
		return true;
	}
			...
			<tr>
				...
				<td colspan="3">
					<div class="input-group" style="width: 100%">
						<div class="dropdown">
<!-- 							<input type="text" readOnly="readOnly" class="form-control" style="width: 56% !important"> -->
							<input type="hidden" name="offerUserCity" id="offerUserCity"/>
							<input type="text" name="offerUserCityValue" id="offerUserCityValue" readOnly="readOnly" class="form-control" style="width: 547px;">
<!-- 							<input type="hidden" name="offerUserNowPlace" id="offerUserNowPlace"/> -->
<!-- 							<input type="text" name="offerUserNowPlaceValue" id="offerUserNowPlaceValue" readOnly="readOnly" class="form-control" style="width: 547px;"> -->
			...
			<tr>
				<td/>
				<td colspan="3">
					<input type="text" readonly name="offerUserPhone" class="form-control" style="width:588px;background:#F5F8F9;"/>
				</td>
			</tr>
			<tr height="48px"/>
			<tr>
			...
			<tr>
				<td/>
				<td colspan="3">
					<input type="text" readonly name="offerUserEmail" class="form-control" style="width:588px;background:#F5F8F9;"/>
				</td>
			</tr>
			<tr height="51px"/>
			<tr>
					...
					<div style="width: 588px">
						<table width="100%">
							<tr>
								...
								<td width="538px">
									<input type="text"  name="offeruserzhihu" class="form-control" style="width:538px;"/>
								</td>
							</tr>
						</table>
					</div>
			...
			<tr>
				...
				<td class="textR">
					<button type="button" class="btn btn-primary" data-toggle="button" onclick="saveData(false)"
						style="font-size:14px;border-color:#CCCCCC;color:#4F4F4F;background-color:#CCCCCC;width:140px;">
						取消
					</button>
					<button type="button" class="btn btn-primary" onclick="saveData(true)" data-toggle="button" id="sex2"
						style="margin-left:19px;font-size:14px;color:#FFF;background-color:#00B389;width:140px;">
						保存
					</button>
				</td>
			</tr>
