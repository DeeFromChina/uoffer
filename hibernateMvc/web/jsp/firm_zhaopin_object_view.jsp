...
<script language="javascript">
	...
	function addhead(item){
		...
		header = header + "<table style='width: 100%;padding-top:5px;padding-left:50px;border-collapse:separate !important;'>"
							...
							+"</tr>"
							+"<tr>"
								+"<td class='textL' style='padding:5px 0px;'><font color='#CCCCCC' style='font-size:14px;' colspan='2'>职位：</font><font style='font-size:14px;color:#4F4F4F;' id='userJob'>"+item.job+"</font></td>"
							+"</tr>"
							+"<tr>"
							+"<td class='textL' style='padding:5px 0px;'><font color='#CCCCCC' style='font-size:14px;'>地点：</font><font color='#4F4F4F' style='font-size:14px;' id='userworkplace'>"+item.workplace+"</font></td>"
							+"<td class='textL' rowspan='2'>"
								+"<button type='button' class='btn btn-primary' onclick='viewresume(" + item.id + ")' data-toggle='button' style='border-radius: 20px;color:#00B389;background:#FFF; border-color: #00B38A; width: 150px'>"
									+"查看详细简历"
								+"</button>"
							+"</td>"
							+"</tr>"
							+"<tr>"
								+"<td class='textL' style='padding:5px 0px;'><font color='#CCCCCC' style='font-size:14px;'>薪酬：</font><font color='#4F4F4F' style='font-size:14px;' id='userMoney'>"+item.money+"</font></td>"
							+"</tr>"
							+"<tr height='20px'/>"
						+"</table>";
		...
		for(var i in items){
			...
			/* if (cStatus == 'true') {
				cStatus = "<td class='textL' style='padding:20px;'>"
					+ "<font style='font-size:14px;' color='#00B38A'>面试成功</font>"
					+ "</td>"
			}
			else {
				cStatus = "";
	...
	function interviewreturn1(title,tvalue){
		var div1 = "<table style='width: 100%;padding-top:5px;padding-left:50px;border-collapse:separate !important;'>"
						+"<tr>"
							+"<td style='width:90px !important;padding:10px 0px;' class='textL'>"
								+"<font style='font-size:14px;color:#4F4F4F;' color='gray' >"+title+"</font>"
							+"</td>"
						+"</tr>"
						+"<br/><br/>"
					+"</table><br/><br/>";
