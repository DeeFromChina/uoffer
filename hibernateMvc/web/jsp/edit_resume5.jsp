...
<script language="javascript">
							...
							+"<table width='100%' id='editMsg'>"
								...
								+"<tr>"
									...
									+"<td class='textC' valign='top' style='padding-top:5px;'>"
										+"<font color='#00B389' style='font-size:14px;' >"+items[i].studstart +"~"+items[i].studend+"</font>"
									+"</td>"
								+"</tr>"
								+"<tr height='13px'/>"
								+"<tr>"
							...
							+"<table width='100%' style='height:100%;'>"
								+"<tr>"
									...
									+"<td width='100px'>"
										...
										+"删除"
										+"</button>" */
										+"<img src='../img/lajitong.png' id='del_"+items[i].thisId+"' onclick='delEdu(this)'/>"
									+"</td>"
									+"<td width='100px'>"
										...
										+"编辑"
										+"</button>" */
										+"<img src='../img/bianji.png' id='edit_"+items[i].thisId+"' onclick='editEdu(this)'/>"
									+"</td>"
									+"<td width='15%'/>"
								+"</tr>"
							+"</table>"
	...
	function editEdu(obj) {
		...
		if (toNow == 'true') {
			...
			document.getElementById("studend").disabled = true;
		}
		else {
			document.getElementById("toNowEdu").checked = false;
			document.getElementById("studend").disabled = false;
		}
		addmsgDiv(data.otherEducate);
		document.getElementById("xiaoshi").style.display="block";
		$("#resumeAddWorkexperienceForm2").populateForm(data);
	...
	function changeToNow() {
		if (document.getElementById("toNowEdu").checked == true) document.getElementById("studend").disabled = true;
		else document.getElementById("studend").disabled = false;
	}
</script>
		...
		<form id="resumeAddWorkexperienceForm2">
			...
			<table width="100%" id="xiaoshi">
				...
				<tr>
					<td/>
					<td colspan="3">
						<input type="text" name="schoolName" id="schoolName" class="form-control" style="width: 441px;">
				...
				<tr>
					<td/>
					<td colspan="3">
						<input type="text" name="xueli" id="xueli" class="form-control" style="width: 441px;">
					</td>
				</tr>
				<tr height="56px"/>
				<tr>
						...
						<table width="100%">
							<tr>
								...
								<td class="textL" valign="bottom">
									...
									<input type="checkbox" id="toNowEdu" name="toNowEdu" onclick="changeToNow()"/><font color="#4F4F4F" style="font-size:16px;" >至今</font>
								</td>
								<td/>
							</tr>
						</table>
				...
				<tr>
					...
					<td colspan="3">
						...
						<input type="text" name="zhuanye" id="zhuanye" class="form-control" style="max-width:789px;min-width:500px;width:90%;">
					</td>
				</tr>
				<tr height="50px"/>
				<tr>
