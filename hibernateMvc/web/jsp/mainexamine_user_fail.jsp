	...
	<center>
		<div style="background: #FFF; width: 80%;">
			<table width="100%">
				<tr height="50px"/>
				<tr>
					<td class="textC" style="padding:10px 0px;font-size:20px;color:#4F4F4F;">很抱歉，您提交的申请没有通过我们的审核，我们暂时无法向您提供合适的机会。</td>
				</tr>
				<tr>
					<td class="textC" style="padding:10px 0px;font-size:20px;color:#4F4F4F;">我们会在有合适机会时联系您，您也可以随时重新提交申请。</td>
				</tr>
				<tr height="67px"/>
				<tr>
					<td class="textC" style="padding:10px 0px;font-size:14px;">
						<div class="btn-group btn-group-lg">
				    		<button type="button" class="btn btn-default" style="width:200px;color:#FFF;background:#00B389;" onclick="javascript:top.location.href='resume_add_information.jsp'">
				    			<font style='font-size:14px;'>重新申请</font>
				    		</button>
				    	</div>
			    	</td>
				</tr>
