...
<script language="javascript">
	...
	function addli(items,liId){
		var li1 = "";
		for(var i in items){
			li1 = li1 + "<li role='presentation' style='width:121px;'>"
	...
	function addCity(items){
		...
		for(var i in items){
			...
			citys = citys + "<td style='padding-top:10px;padding-bottom:10px;width:28px;'>"
	...
	function addFirm(items){
		...
		for(var i in items){
			...
			if(items[i].value.length < 3){
				a = "style='padding-right:13px;font-size:14px;'";
			}else{
				a = "style='font-size:14px;'";
			}
			firms = firms + "<td style='padding-top:10px;padding-bottom:10px;width:28px;'>"
							+"<div class='icheckbox_square-green hover' onclick='firmId(this)' id='"+items[i].id+"'>"
							+"<input type='hidden' value='firm'/>"
								+"<input tabindex='2' type='checkbox' style='opacity:0;'>"
							+"</div>"
						+"</td>"
						+"<td class='textL'"+b+"><font color='#4F4F4F' "+a+" >"+items[i].value+"</font></td>";
						b="";
			if(j == 2){
				firms = firms + "</tr>";
				j = 3;
	...
	<div style="width:100%;">
		<table width="100%">
						...
						<tr>
							<td width="160px">
								<div class="input-group">
									<div class="dropdown">
										<input type="text" id="offerNowGetMoneyType" name="offerNowGetMoneyType" readOnly="readOnly" class="form-control" style="width: 80px !important">
									    ...
									    <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1" style="width: 121px;min-width:121px;" id="money1">
									    </ul>
									</div>
								</div>
							</td>
							<td width="141px">
								...
								<input type="text" class="form-control" style="width:141px;" onchange="moneysum()" id="offerEveryMonthWages" name="offerEveryMonthWages"/>
							</td>
							<td class="textC" width="56px" style="padding:0px 14px;">
							...
							<td width="155px">
								<input type="text" class="form-control" style="width:141px;" onchange="moneysum()" id="offerGetHowMonthWages" name="offerGetHowMonthWages"/>
							</td>
							<td width="41px" class="textC">
					...
					<table width="100%">
						<tr>
							<td width="160px">
								<div class="input-group">
									<div class="dropdown">
										<input type="text" readOnly="readOnly" id="offerPlanGetMoneyType" name="offerPlanGetMoneyType" class="form-control" style="width: 80px !important">
									    <button type="button" style="width:41px;height:41px !important;border:1px #CCCCCC solid;background-color:#F5F8F9;" class="btn dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown">
									        <span class="caret"></span>
									    </button>
									    <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1" style="width:121px;min-width:121px;" id="money2">
									    </ul>
									</div>
								</div>
							</td>
							<td width="141px">
								<input type="text" class="form-control" style="width:141px;" id="offerUserPlanYearWages" name="offerUserPlanYearWages"/>
							</td>
							<td class="textC" width="55px" style="padding-left: 14px;">
			...
			<tr>
				<td/>
				<td colspan="3">
					<textarea rows="8" name="offerRequestNextJob" id="offerRequestNextJob" style="color:#4F4F4F;height:201;max-width:789px;width:75%;min-width:300px;"></textarea>
				</td>
			</tr>
			<tr height="50px"/>
			<tr>
