	...
	<div style="width:100%;height:60px;background:#32373C;position:absolute;top:expression(documentElement.scrollTop + 'px');position:fixed;z-index:9999;">
		<table style="width:100%;white-space: nowrap;">
			<tr>
				...
				<td width="5%"/>
				<td class="textC">
				    <button type="button" style="font-size:14px;height:60px !important;width:100px !important;color:#F5F8F9;background-color:#32373C;" class="btn dropdown-toggle" id="dropdownMenu3" data-toggle="dropdown" class="btn dropdown-toggle" id="dropdownMenu3" data-toggle="dropdown" onmouseover="changeColor1(this)" onmouseout="changeColor2(this)" onclick="goWrite()">
				    	<font>面试邀请</font>
				    </button>
				    <button type="button" style="font-size:14px;height:60px !important;width:100px !important;color:#F5F8F9;background-color:#32373C;"class="btn dropdown-toggle" id="dropdownMenu2" data-toggle="dropdown" onmouseover="changeColor1(this)" onmouseout="changeColor2(this)" onclick="goWrite()">
				    	<font>我的简历</font>
				    </button>
			    </td>
		...
		<div style="background: #FFFFFF; width: 800px;">
			<table width="100%">
				...
				<tr>
					<td width="123px"/>
					<td class="textC">
						<font style="font-size:24px;" color="#4F4F4F">该账号已激活</font>
					</td>
					<td width="123px"/>
				</tr>
				<tr height="55px"/>
				...
				<tr>
					<td/>
					<td class="textC">
						<font style="font-size:16px" color="#4F4F4F">请用户信息，并提交审核。</font>
					</td>
					<td/>
				</tr>
				<tr height="55px"/>
				<tr>
					<td/>
					<td class="textC">
						<button type="button" class="btn btn-default" style="width:280px;color:#FFF;background:#00B38A;" onclick="javascript:top.location.href='resume_add_information.jsp'">
							填写信息
						</button>
					</td>
					<td/>
