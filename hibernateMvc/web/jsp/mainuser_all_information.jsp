...
<body bgcolor="#FFF" onload="init()" style="overflow-y:hidden;">
	...
	<div style="width:100%;height:73px;margin-top:60px;background:#3CBAFF;position:absolute;top:expression(documentElement.scrollTop + 'px');position:fixed;z-index:9999;min-width:1000px;">
		<ul id="myTab" class="nav nav-tabs" style="padding:0px 14%;height:41px;margin-top:32px;border-bottom:1px #FFF solid;">
	...
	<div id="myTabContent" class="tab-content" style="background:#F5F8F9;height:100%;">
	    <div class="tab-pane fade in active" id="userinformation" style="height:100%;padding-top:128px;">
