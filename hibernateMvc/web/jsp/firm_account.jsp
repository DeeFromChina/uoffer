...
<script language="javascript">
	...
	function goSumbit(){
		/* if(isResetLogin()) {
			...
			if(data == "success"){
				alert("提交成功!");
				document.getElementById('remark').innerText = document.getElementById('beizhu').value;
			}else{
				alert("保存出错!");
			}
			window.location.href="firm_account.jsp";
		/* } */
	}
	...
	function addfirm(items){
		...
		firm = firm + "<div style='width:100%;padding:60px 14%;'>"
							+ "<table width='100%' style='border-bottom:1px #CCCCCC solid;'>"
								...
								+ "<tr>"
									...
									+ "<td valign='bottom' style='padding-left:40px;'>"
										+ "<font color='#4F4F4F' style='font-size:14px;'>"+items[i].userName+"</font>"
										+ "<font style='font-size:14px;' color='#3CBAFF'>"+items[i].userType+"</font>"
									+ "</td>"
								+ "</tr>"
								+ "<tr>"
									+ "<td valign='bottom' style='height:25px;padding-left:40px;'>"
										+ "<font color='#4F4F4F' style='font-size:14px;'>注册时间："+items[i].createTime+"</font>"
									+ "</td>"
								+ "</tr>"
								+ "<tr>"
									+ "<td valign='top' style='height:25px;padding-left:40px;'>"
										+ "<font color='#4F4F4F' style='font-size:14px;'>最新登陆："+items[i].updataTime+"</font>"
									+ "</td>"
								+ "</tr>"
								+ "<tr>"
							...
							+ "<table width='100%' style='border-bottom:1px #CCCCCC solid;border-collapse:separate;border-spacing:20px;' cellpadding='10'>"
								+ "<tr>"
									+ "<td width='100px'><font color='#4F4F4F' style='font-size:14px;'>公司</font></td>"
									+ "<td><font style='font-size:14px;' color='#3CBAFF'>"+items[i].firmName+"</font></td>"
								+ "</tr>"
								+ "<tr>"
									+ "<td width='100px'><font color='#4F4F4F' style='font-size:14px;'>职位</font></td>"
									+ "<td><font style='font-size:14px;' color='#3CBAFF'>"+items[i].job+"</font></td>"
								+ "</tr>"
								+ "<tr>"
									+ "<td width='100px'><font color='#4F4F4F' style='font-size:14px;'>手机</font></td>"
									+ "<td><font style='font-size:14px;' color='#3CBAFF'>"+items[i].phone+"</font></td>"
								+ "</tr>"
								+ "<tr>"
									+ "<td width='100px'><font color='#4F4F4F' style='font-size:14px;'>通知信息</font></td>"
									+ "<td><font style='font-size:14px;' color='#3CBAFF'>已开启："+items[i].msg+"</font></td>"
								+ "</tr>"
								+ "<tr>"
									+ "<td width='100px'><font color='#4F4F4F' style='font-size:14px;'>目前状态</font></td>"
									+ "<td><font style='font-size:14px;' color='#FE9B00' id='status'>"+items[i].status+"</font></td>"
								+ "</tr>"
								+ "<tr>"
									+ "<td width='100px'><font color='#4F4F4F' style='font-size:14px;'>顾问备注</font></td>"
									+ "<td><font style='font-size:14px;' color='#FE9B00' id='remark'>"+items[i].remark+"</font></td>"
								+ "</tr>"
							+ "</table>"
						+ "</div>";
		}
		...
		var save = "<div style='width:100%;padding:20px 200px;'>"
				...
				+ "<tr>"
					+ "<td><font color='#4F4F4F' style='font-size:14px;'>顾问审核</font></td>"
				+ "</tr>"
				+ "<tr>"
					+ "<td>"
	...
	function addtable(){
		var a = "";
		a = a + "<table style='width:100%;height:81px;background:#32373C;' id='botom'>"
				+"<tr>"
					+"<td class='textC'>"
...
<body bgcolor="#FFF" onload="init()">
	...
	<div style="width:100%;padding:40px 14%;display:none;" id="main">
		<table width="100%" style="border-bottom:1px #CCCCCC solid;margin-top:60px;">
			<tr>
				...
				<td valign="bottom" style="padding-left:40px;">
					...
					<font style='font-size:14px;color:#4F4F4F;' color="#3CBAFF" id="usershenfen">管理员</font>
				</td>
			</tr>
			<tr>
				<td valign="bottom" style="height:25px;padding-left:40px;">
		...
		<table width="100%" style="border-bottom:1px #CCCCCC solid;border-collapse:separate;border-spacing:20px;" cellpadding="10">
			<tr>
				<td width="100px"><font style='font-size:14px;color:#4F4F4F;'>公司</font></td>
				<td><font style='font-size:14px;' color="#3CBAFF" id="firmName">百度</font></td>
			</tr>
			<tr>
				<td width="100px"><font style='font-size:14px;color:#4F4F4F;'>职位</font></td>
				<td><font style='font-size:14px;' color="#3CBAFF" id="job">CEO</font></td>
			</tr>
			<tr>
				<td width="100px"><font style='font-size:14px;color:#4F4F4F;'>手机</font></td>
				<td><font style='font-size:14px;' color="#3CBAFF" id="phone">133464356</font></td>
			</tr>
			<tr>
				<td width="100px"><font style='font-size:14px;color:#4F4F4F;'>通知信息</font></td>
				<td><font style='font-size:14px;' color="#3CBAFF" id="tongzhi">已开启：邮件通知，邮件订阅</font></td>
			</tr>
			<tr>
				<td width="100px"><font style='font-size:14px;color:#4F4F4F;'>目前状态</font></td>
				<td><font style='font-size:14px;' color="#FE9B00" id="status">审核中</font></td>
			</tr>
			<tr>
				<td width="100px"><font style='font-size:14px;color:#4F4F4F;'>顾问备注</font></td>
				<td></td>
			</tr>
		</table>
		<table width="100%" style="border-collapse:separate;border-spacing:20px;">
			<tr>
				<td><font style='font-size:14px;color:#4F4F4F;'>顾问审核</font></td>
			</tr>
			<tr>
				<td>
					<div class="input-group" style="width: 100%;">
