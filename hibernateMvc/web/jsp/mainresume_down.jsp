...
<body bgcolor="#FFFFFF" onload="init()" height="852px">
	...
	<div style="width:100%;height:60px;background:#32373C;position:absolute;top:expression(documentElement.scrollTop + 'px');position:fixed;z-index:9999;">
		<table style="width:100%;white-space: nowrap;">
			<tr>
				<td style="width:19%;padding-left:13%;"><a href="#" onclick="javascript:top.location.href='homepage.jsp'"><img src="../img/U-Offerlogo.png" width="109px" height="26px"></a></td>
			    <td width="4%"/>
				<td>
				    <button type="button" style="height:60px !important;background-color:#32373C;" class="btn dropdown-toggle" id="dropdownMenu3" data-toggle="dropdown" class="btn dropdown-toggle" id="dropdownMenu3" data-toggle="dropdown" onmouseover="changeColor1(this)" onmouseout="changeColor2(this)" onclick="booleanInfot('interview.jsp')">
				    	<font color="#F5F8F9" style="font-size:14px;">面试邀请</font>
				    </button>
				    <button type="button" style="height:60px !important;background-color:#32373C;"class="btn dropdown-toggle" id="dropdownMenu2" data-toggle="dropdown" onmouseover="changeColor1(this)" onmouseout="changeColor2(this)" onclick="booleanInfot('resume_edit.jsp')">
				    	<font color="#F5F8F9" style="font-size:14px;">我的简历</font>
				    </button>
			    </td>
			    <td width="19%">
				    <button type="button" style="height:60px !important;background-color:#32373C;" class="btn dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown" onmouseover="changeColor1(this)" onmouseout="changeColor2(this)" onclick="javascript:top.location.href='personal_settings.jsp'">
				    	<font color="#F5F8F9" style="font-size:14px;">个人设置</font>
				    </button>
				    <button type="button" style="height:60px !important;background-color:#32373C;" class="btn dropdown-toggle" id="dropdownMenu4" data-toggle="dropdown" onmouseover="changeColor1(this)" onmouseout="changeColor2(this)" onclick="javascript:top.location.href='login.jsp'">
	...
	<center>
		<div style="background: #FFFFFF;width:100%;height:43%;">
			<table width="100%" height="100%">
				...
				<tr>
					<td class="textC" style="padding:10px 0px;">
						<button type="button" style="height:41px;width:200px;background-color:#00B38A;" class="btn dropdown-toggle" onclick="javascript:window.location.href='resume_add_information.jsp'">
		...
		<div style="background: #FFFFFF;">
			<table style="border-collapse: separate; border-spacing: 10px; width: 100%;">
				<tr>
					<td class="textC" style="padding:10px 0px;" colspan="4"><font style='font-size:20px;color:#4F4F4F;'>完善简历</font></td>
				</tr>
				<tr>
		...
		<div style="background: #FFFFFF; width: 80%;">
			...
			<table
				...
				<tr>
					<td width="33%"/>
					<td class="textC" style="padding:10px 0px;"><font style='font-size:20px;color:#4F4F4F;'>看看申请后会发生什么</font></td>
					<td width="33%"/>
				</tr>
				<tr>
		...
		<div style="background: #FFFFFF; width: 80%;">
			...
			<table
				...
				<tr>
					<td width="33%"/>
					<td class="textC" style="padding:10px 0px;"><font style='font-size:20px;color:#4F4F4F;'>最近在U-offer招聘的企业</font></td>
					<td width="33%"/>
				</tr>
				<tr>
