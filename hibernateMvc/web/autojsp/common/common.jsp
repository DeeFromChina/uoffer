...
<%-- <script src="<%=baseJs2 %>jquery-3.1.1.js?randomId=<%=Math.random()%>" type="text/javascript"></script> --%>
...
<script src="<%=baseJs2 %>ajaxfileupload.js?randomId=<%=Math.random()%>" type="text/javascript"></script>
