...
function test(){
	...
	var condition = document.getElementById("txtKey").value;
	$("p").each(function(){
		var c = this.innerText.search(condition);
		if(c > -1){
			this.innerText = "<font>1</font>";
		}
	});
}
...
<!-- <input type="text" id="txtKey" value="8：00 起售车站" /><input type="button" value="查找" id="btnSearch" onclick="test()"/> -->
    <div id="pretime">
        <p>
            <strong>8：00 起售车站</strong><br />
            北京西、南京、南京南。
        </p>
        <p>
            <strong>8：30 起售车站</strong><br />
            白城、成都东、东莞、东莞东、惠州、济宁、南充、宁波、日照、山海关、汕头、松原、乌兰浩特、乌鲁木齐南、南充北。
        </p>
        <p>
            <strong>9：00 起售车站</strong><br />
        ...
        <p>
            <strong>12：00 起售车站</strong><br />
            安阳、安阳东、宝鸡、宝鸡南、北京北、汉口、江山、金华、兰溪、临汾、临汾西、龙游、衢州、新乡、新乡东、义乌、运城、运城北、长春、长春西、诸暨、武义北、永康南、缙云西。
        </p>
        <p>
            <strong>12：30 起售车站</strong><br />
            安庆、安庆西、北京南、巢湖、肥东、广元、汉中、合肥、合肥北城、合肥南、黄梅、金寨、六安、庐江、绵阳、全椒、舒城、太湖、天柱山、桐城、武昌、宿松、广元南、昭化、合肥西、长临河、巢湖东、无为&nbsp;。
        </p>
        <p>
            <strong>13：00 起售车站</strong><br />
            亳州、赤峰、达州、大连、大连北、阜南、阜阳、广州南、淮南、淮南东、霍邱、内江、三堂集、水家湖、天津南、天津西、通辽、昭通、郑州东、贾鲁河、绿博园、运粮河、宋城路、内江北、南曹、孟庄、新郑机场。
        </p>
        <p>
            <strong>13：30 起售车站</strong><br />
            博鳌、大同、东方、海口、海口东、吉林、陵水、六盘水、美兰、琼海、三亚、上海虹桥、神州、天津、万宁、文昌、武汉、亚龙湾、遵义。
        </p>
        <p>
            <strong>14：00 起售车站</strong><br />
            北滘、碧江、常平、潮汕、潮阳、潮州、春湾、大埔、丹霞山、东升、丰顺、佛山、高州、古镇、光明城、广州北、和平、河源、鲘门、呼和浩特、呼和浩特东、虎门、华城、惠东、惠州南、惠州西、济南、济南东、济南西、江门、揭阳、葵潭、乐昌、雷州、龙川、陆丰、茂名东、梅州、明珠、南朗、南头、南雄、坪石、普宁、前山、清远、庆盛、饶平、容桂、三水、汕尾、韶关、韶关东、深圳坪山、石家庄、石家庄北、始兴、顺德、顺德学院、太原南、唐家湾、小榄、新会、新兴县、信宜、兴宁、徐闻、阳春、英德、英德西、源潭、湛江、湛江西、樟木头、肇庆、郑州、郑州西、中山、中山北、珠海、珠海北、郁南、南江口、云浮东、怀集、广宁、三水南、肇庆东。
        </p>
        <p>
            <strong>14：30 起售车站</strong><br />
            包头、包头东、长沙南、德州、德州东、邯郸、邯郸东、昆明、攀枝花、上海、太原、西昌、宜昌、宜昌东。
        </p>
        <p>
            <strong>15：00 起售车站</strong><br />
