...
public final class user_005ftuijian_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\tvar url = \"login/houTaiFirmInformation1.do?pageId=\" + 1;\r\n");
      ...
      out.write("\t\tvar url = \"login/houTaiFirmInformation1.do\";\r\n");
      out.write("\t\tvar formId = \"finduserForm\";\r\n");
      out.write("\t\tvar data = ajaxSumbit(url, formId);\r\n");
      out.write("\t\taddList(data.firmList);\r\n");
      out.write("\t\tdocument.getElementById(\"allNum\").innerText=data.allNum;\r\n");
      ...
      out.write("\t\talert(firmcity);\r\n");
      out.write("\t\tvar firmcityValue = document.getElementById('firmcityValue').value;\r\n");
      out.write("\t\talert(firmcityValue);\r\n");
      out.write("\t\tvar firmjob = document.getElementById('firmjob').value;\r\n");
      out.write("\t\talert(firmjob);\r\n");
      out.write("\t\tvar firmjobValue = document.getElementById('firmjobValue').value;\r\n");
      out.write("\t\talert(firmjobValue);\r\n");
      out.write("\t\tvar firmName = document.getElementById('firmName').value;\r\n");
      out.write("\t\talert(firmName);\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tvar url = \"login/houTaiFirmInformation1.do\";//?pageId=\" + pageId + \"&firmcityValue=\" + firmcityValue + \"&firmstatus=\" + firmstatus;\r\n");
      out.write("\t\tvar formId = \"finduserForm\";\r\n");
      out.write("\t\tvar data = ajaxSumbit(url, formId);\r\n");
      out.write("\t\taddList(data.firmList);\r\n");
      out.write("\t}\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t+\"<font style='font-size:14px;' color='#4F4F4F'>\"+items[i].lingyu+\"</font>\"\r\n");
      out.write("\t\t\t\t\t\t\t+\"</td>\"\r\n");
      out.write("\t\t\t\t\t\t\t+\"<td class='textC'>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t+\"<font style='font-size:14px;' color='#4F4F4F'>\"+items[i].name+\"</font>\"\r\n");
      out.write("\t\t\t\t\t\t\t+\"</td>\"\r\n");
      out.write("\t\t\t\t\t\t\t+\"<td class='textC'>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t+\"<font style='font-size:14px;' color='#4F4F4F'>\"+items[i].guimo+\"</font>\"\r\n");
      out.write("\t\t\t\t\t\t\t+\"</td>\"\r\n");
      out.write("\t\t\t\t\t\t\t+\"<td class='textC'>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t+\"<font style='font-size:14px;' color='#4F4F4F'>\"+items[i].rongzi+\"</font>\"\r\n");
      out.write("\t\t\t\t\t\t\t+\"</td>\"\r\n");
      out.write("\t\t\t\t\t\t\t+\"<td class='textC'>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t+\"<font style='font-size:14px;' color='#4F4F4F'>\"+items[i].shenqingren+\"</font>\"\r\n");
      out.write("\t\t\t\t\t\t\t+\"</td>\"\r\n");
      out.write("\t\t\t\t\t\t\t+\"<td class='textC'>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t+\"<font style='font-size:14px;' color='#4F4F4F'>\"+items[i].zhiwei+\"</font>\"\r\n");
      out.write("\t\t\t\t\t\t\t+\"</td>\"\r\n");
      out.write("\t\t\t\t\t\t\t+\"<td class='textC'>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t+\"<font style='font-size:14px;' color='#4F4F4F'>\"+items[i].shenqingtime+\"</font>\"\r\n");
      out.write("\t\t\t\t\t\t\t+\"</td>\"\r\n");
      out.write("\t\t\t\t\t\t\t+\"<td class='textC'>\"\r\n");
      ...
      out.write("\t\t<table width=\"100%\" style=\"min-width:220px;\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"firmcityValue\" id=\"firmcityValue\" class=\"form-control\" placeholder=\"城市\" style=\"font-size:14px;width: 120px !important\" readonly>\r\n");
      ...
      out.write("\t\t\t\t\t\t    </button>\r\n");
      out.write("\t\t\t\t\t\t    <ul class=\"dropdown-menu\" role=\"menu\" aria-labelledby=\"dropdownMenu1\" style=\"width: 161px;max-height:100px;overflow-y:auto;\" id=\"city\">\r\n");
      out.write("\t\t\t\t\t\t        \r\n");
      out.write("\t\t\t\t\t\t    </ul>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t<div class=\"input-group\" style=\"display:inline;width: 100%;\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"dropdown\" style=\"\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"hidden\" name=\"firmstatus\" id=\"firmstatus\"/>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"firmstatusValue\" id=\"firmstatusValue\" class=\"form-control\" placeholder=\"状态\" style=\"font-size:14px;width: 120px !important\" readonly>\r\n");
      out.write("\t\t\t\t\t\t    <button type=\"button\" style=\"width:41px;height:41px !important;background-color:#3CBAFF;color:#FFF;\" class=\"btn dropdown-toggle\" id=\"dropdownMenu1\" data-toggle=\"dropdown\">\r\n");
      out.write("\t\t\t\t\t\t        <span class=\"caret\"></span>\r\n");
      out.write("\t\t\t\t\t\t    </button>\r\n");
      out.write("\t\t\t\t\t\t    <ul class=\"dropdown-menu\" role=\"menu\" aria-labelledby=\"dropdownMenu1\" style=\"width: 161px;max-height:100px;overflow-y:auto;\" id=\"status\">\r\n");
      out.write("\t\t\t\t\t\t        \r\n");
      out.write("\t\t\t\t\t\t    </ul>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</td> -->\r\n");
      out.write("\t\t\t\t<td width=\"390px\">\r\n");
      out.write("\t\t            <input type=\"text\" class=\"form-control\" style=\"width:361px;\" placeholder=\"搜索\" id=\"firmName\" name=\"firmName\">\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t<td class=\"textL\">\r\n");
      out.write("\t\t\t\t\t<button type=\"button\" class=\"btn btn-primary\" onclick=\"validateCode()\" data-toggle=\"button\"\r\n");
      out.write("\t\t\t\t\tstyle=\"background-color: #3CBAFF; border-color: #3CBAFF;font-size:14px; color:#FFF; width: 150px;\">\r\n");
      out.write("\t\t\t\t\t搜索</button>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t</table>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t</form>\r\n");
      out.write("\t<div style=\"width:100%;height:94%;padding:20px 14%;\">\r\n");
      ...
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"textC\" style=\"background:#E2E2E2;\">\r\n");
      out.write("\t\t\t\t\t\t<font style=\"font-size:14px;\" color=\"#4F4F4F\">招聘负责人</font>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"textC\" style=\"background:#E2E2E2;\">\r\n");
      ...
      out.write("\t\t\t</tr> -->\r\n");
      out.write("\t\t</table>\r\n");
      out.write("\t\t<div style=\"padding:58px 0px;\">\r\n");
