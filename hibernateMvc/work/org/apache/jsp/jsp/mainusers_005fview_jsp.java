 ...
 * Generated at: 2017-05-15 07:57:56 UTC
...
public final class mainusers_005fview_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t+\"<table style='width:100%;max-width:180px;'>\"\r\n");
      out.write("\t\t\t\t\t\t\t+\"<tr>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t+\"<td rowspan='4' width='40px'>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t+\"<div style='width:100%;border-radius:50%; overflow:hidden;'>\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t+\"</tr>\"\r\n");
      out.write("\t\t\t\t\t\t\t+\"<tr>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t+\"<td class='textL' style='padding-left:20px;'><font style='font-size:14px;' color='#4F4F4F'>\" +items[i].name+\"</font></td>\"\r\n");
      out.write("\t\t\t\t\t\t\t+\"</tr>\"\r\n");
      out.write("\t\t\t\t\t\t\t+\"<tr>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t+\"<td class='textL' style='padding-left:20px;'><font style='font-size:14px;' color='#4F4F4F''>\"+items[i].job+\"</font></td>\"\r\n");
      out.write("\t\t\t\t\t\t\t+\"</tr>\"\r\n");
      out.write("\t\t\t\t\t\t\t+\"<tr>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t+\"<td class='textL' style='padding-left:20px;word-break:break-all'><font style='font-size:14px;' color='#4F4F4F'>\"+items[i].money+\"</font></td>\"\r\n");
      out.write("\t\t\t\t\t\t\t+\"</tr>\"\r\n");
      out.write("\t\t\t\t\t\t\t+\"<tr height='20px'/>\"\r\n");
      out.write("\t\t\t\t\t\t\t+\"<tr height='20px'>\"\r\n");
      out.write("\t\t\t\t\t\t\t\t+\"<td class='textL' colspan='2'><font style='font-size:12px;' color='#4F4F4F'>\"+items[i].time+\"</font></td>\"//\r\n");
      out.write("\t\t\t\t\t\t\t+\"</tr>\"\r\n");
      out.write("\t\t\t\t\t\t+\"</table>\"\r\n");
      out.write("\t\t\t\t\t+\"</div>\";\r\n");
      out.write("\t\t}\r\n");
      ...
      out.write("\t\tobj.style.background=\"#D6F5E9\";\r\n");
      out.write("\t}\r\n");
